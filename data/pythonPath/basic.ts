...
export const basicPathUnits: Unit[] = [
  {
    ...
    lessons: [
      ...
      makeLesson("bas-u1-l5", "beg-migo-intro-card", "Migo'nun Tanışma Kartı", "6 dk", "Mini Proje"),
    ],
  },
  {
    id: "bas-unit-2",
    ...
    lessons: [
      makeLesson("bas-u2-l1", "bas-comparisons", "Karşılaştırmalar", "5 dk", "Kısa ders"),
      makeLesson("bas-u2-l2", "bas-if-elif-else", "if/elif/else tekrarı", "5 dk", "Kısa ders"),
  ...
  },
  {
    ...
    lessons: [
      makeLesson("bas-u3-l1", "bas-params-return", "Parametre ve return", "5 dk", "Kısa ders"),
      makeLesson("bas-u3-l2", "bas-function-design", "Fonksiyon tasarlama", "5 dk", "Kısa ders"),
      makeLesson("bas-u3-l3", "bas-helper-functions", "Yardımcı fonksiyonlar", "6 dk", "Pratik"),
      makeLesson("bas-u3-l4", "bas-calculator", "Mini proje: Basit hesap makinesi", "8 dk", "Mini görev"),
    ],
  },
  {
    id: "bas-unit-4",
    ...
    lessons: [
      makeLesson("bas-u4-l1", "bas-list-review", "Liste tekrarı", "5 dk", "Kısa ders"),
      makeLesson("bas-u4-l2", "bas-dict-intro", "Sözlük (dict) mantığı", "6 dk", "Kısa ders"),
      makeLesson("bas-u4-l3", "bas-list-dict-diff", "Liste ve dict farkı", "5 dk", "Pratik"),
    ],
  },
  {
    id: "bas-unit-5",
    ...
    lessons: [
      makeLesson("bas-u5-l1", "bas-for-review", "for ve range tekrarı", "5 dk", "Kısa ders"),
      makeLesson("bas-u5-l2", "bas-list-processing", "Liste üzerinde işlem", "6 dk", "Pratik"),
      makeLesson("bas-u5-l3", "bas-contact-book", "Mini proje: Kişi rehberi", "8 dk", "Mini görev"),
      makeLesson("bas-u5-l4", "bas-sum-average", "Toplam ve ortalama bulma", "6 dk", "Uygulama"),
      makeLesson("bas-u5-l5", "bas-expense-tracker", "Mini proje: Harcama özeti", "8 dk", "Mini görev"),
    ],
  },
  {
    id: "bas-unit-6",
